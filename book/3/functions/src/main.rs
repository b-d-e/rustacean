...
fn another_function() {
    // we use snake case in function and variable names
    println!("Another function.");
}

fn and_another(x: i32) {
    // specify parameter, with it's type annotation
...
fn print_labeled_measurement(value: i32, unit_label: char) {
    // two parameters, each with their own
...
fn five() -> i32 {
    // specify return type with -> notation
